  ...
  if (elements.length > 0) {
    ...
    var interval = setInterval(function() {
      if (i < monTexte.length) {
        ...
        element.insertAdjacentHTML('beforeend', '<a href="javascript:void(0)" onclick="supprimerBackground()" class="eightbit-btn">Continue</a>');
      }
    }, 100); // 100 millisecondes entre chaque caractère
  } else {
    console.log("Aucun élément avec la classe 'bubble grow left' n'a été trouvé.");
  }
}
